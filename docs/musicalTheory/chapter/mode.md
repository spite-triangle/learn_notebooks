...
![alt](../image/foundation/toneMarkTable.jpg)
...
![alt](../image/foundation/modes.jpg)
...
![alt](../image/foundation/naturalMode.jpg)

**自然大调只是定义了音名的排列规则，还得确定是从哪个开始排列的，这样才能区分表中的七个自然大调，这里就直接利用排列的第一个音名进行区分**

![alt](../image/foundation/naturalModes.jpg)
...
- 音阶是有序。一个音阶，要么上行，要么下行，在上行中不能插入下行
    ![alt](../image/foundation/scaleOrder.jpg)
- 音阶中要包含调式中的所有音
...
![alt](../image/foundation/scaleRiseC.jpg)

黑键的音名是由`CDEFGAB`通过变音符号变化而来的，同样黑键也能作为自然大调的起始。根据自然大调规则写出 #C 大调：

![alt](../image/foundation/scaleRiseC1.jpg)
...
![alt](../image/foundation/equalScale.jpg)

对于 #C 大调与 bB 大调而言，他们本质上的音都是等音的，因此 #C 大调与 bB 大调的之间的关系就被称之为「等音大调」


![alt](../image/foundation/equalScales.jpg)
...
![alt](../image/foundation/scales.jpg)
...
![alt](../image/foundation/sol-fa1.jpg)

# 调的改变

![alt](../image/foundation/toneChange.jpg)
