...
![alt](../image/foundation/majorScale.jpg)
...
![alt](../image/foundation/syllableNames.jpg)
...
![alt](../image/foundation/toneSeries.jpg)
...
![alt](../image/foundation/lowHighPitch.jpg)
...
- **A大调**：挑选出来的七个音阶从 `A` 开始
    ![alt](../image/foundation/AmajorScale.jpg)
...
**G大调的两种唱名：**
![alt](../image/foundation/sol-fa.jpg)


# 简谱介绍

![alt](../image/foundation/simpleScoreZelda.webp)
...
- **拍号 (time signature)：** 分子表示一个小节（`| ... |` 为一个小节）有多少拍；分母表示几分音符为一拍。 **描述的谱子里音符的基本节奏**
    ![alt](../image/foundation/timeSignature.jpg)
