...
![alt](../image/foundation/crotchetBeat.jpg)


以二分音符为一拍时

![alt](../image/foundation/minimBeat.jpg)


## 小节

![alt](../image/foundation/bar.jpg)
...
![alt](../image/foundation/barNumber.jpg)
...
![alt](../image/foundation/dot.jpg)

- **附点：** 延长前面音符本身时值（拍数）的一半

![alt](../image/foundation/doubleDot.jpg)
...
![alt](../image/foundation/tie.jpg)
![alt](../image/foundation/tie1.jpg)

**延音线：** 将多个 **相同音符** 的连接起来，从第一个音发出声音，延长时间为所有音符表示的时值（拍数）之和。例如以四分音符为一拍，上图表示的就是 **1.25拍**

![alt](../image/foundation/beyondBar.jpg)
...
![alt](../image/foundation/legato.jpg)
...
![alt](../image/foundation/fortePiano.jpg)
...
- **变换拍子：** 在乐谱的横向，发生了拍号的改变，即同一乐器演奏时，乐谱的拍号发生了改变
    ![alt](../image/foundation/changeMeter.jpg)

- **交错拍子：** 在乐谱的纵向，发生了拍号的改变，即多个乐器同时演奏，但是各个乐谱的拍号不一样。
    ![alt](../image/foundation/crossMeter.jpg)


## 弱起小节

![alt](../image/foundation/weakBar.jpg)
...
![alt](../image/foundation/splitSignature.jpg)
...
- 慢速、中速、快速
    ![alt](../image/foundation/speedLevel.jpg)

- x板
    ![alt](../image/foundation/grave.jpg)